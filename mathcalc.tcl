...
if [winfo exists .button1] {destroy .button1 .button2 .button3 .button4 .button5}
...
button .button5 -command {.msg1 configure -text "$entry1Var % $entry2Var = [expr $entry1Var%$entry2Var]"} -text "Remainder"
pack .msg1 .entry1 .entry2 .button1 .button2 .button3 .button4 .button5